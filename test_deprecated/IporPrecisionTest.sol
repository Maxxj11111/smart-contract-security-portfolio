...
import "../src/IporPrecisionMock.sol";

contract IporPrecisionTest is Test {
    IporPrecisionMock ipor;
    address victim = address(0x1);

    function setUp() public {
        ipor = new IporPrecisionMock();
    ...
    function testExploit() public {
        ...
        // --- ЭКСПЛУАТАЦИЯ ---
        // Жертва вносит 1 wei. 
        // Математика IPOR: (1 * 1e18) / 2 ether = 0 (из-за целочисленного деления)
